...
<script>
  $(document).ready(function(){
      let x = document.getElementById(p_name);
              ...
              <div class="leftcontact">
                    <div class="form-group">
                      ...
                      <span class="icon-case"><i class="fa fa-male"></i></span>
                        <input type="text" name="p_name" id="p_name" data-rule="required" />
        ...
        DATE OF BIRTH :<span>*</span><input placeholder="dd/mm/yyyy" type="date" name="p_dob" id="date" value="<?php if ($mode=='Edit') echo $row['p_dob']?>" required>
          ...
          <div class="form-group">
              ...
              <span class="icon-case"><i class="fa fa-phone"></i></span>
                <input type="text" name="p_phone" id="p_phone" data-rule="maxlen:10" />
              ...
              <span class="icon-case"><i class="fa fa-comments-o"></i></span>
                        <textarea name="password" rows="14" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Message' doit être renseigné."></textarea>
                        <div class="validation"></div>
              </div>  
          </div>
          </div>
...
<script>
  function myFunction(){
 var x =  document.getElementById("phone_error").val();
  if(x == 10){
